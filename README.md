...
| submodel.datasource.enable                           | X        | true                                        | Your SDE hostname                   |
| submodel.datasource.hostname                         | X        | https://example.sdehost.com                 | Your SDE hostname                   |
| submodel.datasource.apiKeyHeader                     | X        | API_KEY                                     | Your default key                    |
| submodel.datasource.apiKey                           | X        | yourpass                                    | Your default key password           |
...
# This should only be true if a separate sub-model data source server is used; it should be false in all other cases. 
submodel.datasource.enable=true
#Use the SDE host url which will share with EDC connector as data address proxy if no seperated submodel server is used
submodel.datasource.hostname=https://example.sdehost.com
submodel.datasource.apiKeyHeader=your default key
submodel.datasource.apiKey=your default key password
